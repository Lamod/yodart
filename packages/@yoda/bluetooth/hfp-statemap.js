...
var stateFilters = [
  ...
  // incoming call
  {
    inflowMsg: {hfpstate: 'opened', connect_state: 'connected', setup: 'incoming'},
  ...
  // call connected
  {
    inflowMsg: {hfpstate: 'opened', connect_state: 'connected', call: 'active', setup: 'none'},
    outflowEvent: {type: 'call_state_changed', state: protocol.CALL_STATE.OFFHOOK}
  },
  {
    inflowMsg: {hfpstate: 'opened', connect_state: 'connected', call: 'inactive', setup: 'outgoing'},
    outflowEvent: {type: 'call_state_changed', state: protocol.CALL_STATE.OFFHOOK}
  }
]
